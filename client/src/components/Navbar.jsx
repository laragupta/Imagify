...
const Navbar = () => {
    ...
    // it is data destructuring here we can write also 
    // const abcd=useContext(AppContext)
    // const userdata=abcd.user
     ...
     <div>
        ...
        <div className='flex items-center gap-2 sm:gap-3'>
            <button onClick={()=>navigate('/buyCredit')}className='flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-700'>
                ...
                <p className='text-xs sm:text-sm font-mediium text-gray-600'>Credits Left:{credit}</p>
            </button>
        ...
        <div className='flex items-center gap-2 sm:gap-5'>
            ...
            <button onClick={()=>setShowLogin(true)}className='bg-zinc-800
             text-white px-10 py-2 sm:px-2 text-sm 
